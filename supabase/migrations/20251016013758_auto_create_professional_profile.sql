-- =====================================================
-- AUTO CREATE PROFILE AND PROFESSIONAL PROFILE

-- =====================================================
-- This migration updates the handle_new_user() function
-- to automatically create BOTH profiles and professional_profiles
-- for ALL users (except admins). This allows all users to have
-- dual functionality: they can be both clients and professionals.
-- =====================================================

-- Update the handle_new_user function to create both profile and professional_profile
...
-- =====================================================
-- New Business Rule:
-- - ALL non-admin users automatically get BOTH profile and professional_profile
-- - user_type is automatically set to 'both' for all regular users
-- - Users can function as both clients and professionals
-- - default_mode determines which view they see first (client or professional)
--
-- Usage examples:
--
-- Regular user signup (creates both profiles):
-- raw_user_meta_data: {
--   "full_name": "Juan Perez",
--   "default_mode": "client"  // Optional, defaults to 'client'
-- }
--
-- User with professional details (creates both profiles with extra data):
-- raw_user_meta_data: {
--   "full_name": "Maria Santos",
--   "default_mode": "professional",
--   "category_id": "7ab2e56d-a2d6-46c8-8321-ab1c32e7273f",
--   "business_name": "Electricidad Santos",
--   "tagline": "10 años de experiencia",
--   "years_experience": 10
-- }
--
-- Admin user signup (only creates profile, no professional_profile):
-- raw_user_meta_data: {
