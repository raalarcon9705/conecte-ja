      ...
      <Container>
        ...
        <View className="mb-6">
          ...
          <Card variant="outlined" padding="none">
            ...
            >
              <View className={`w-10 h-10 rounded-full items-center justify-center mr-3 ${currentMode === 'client' ? 'bg-blue-100' : 'bg-gray-100'
                }`}>
            ...
            <TouchableOpacity
              ...
              disabled={isSwitchingMode}
            >
              <View className={`w-10 h-10 rounded-full items-center justify-center mr-3 ${currentMode === 'professional' ? 'bg-blue-100' : 'bg-gray-100'
                }`}>
